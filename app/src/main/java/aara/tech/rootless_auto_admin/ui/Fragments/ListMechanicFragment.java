...
public class ListMechanicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_list_mechanic, container, false);
    ...
    private void mechanicNetworkCall() {
        Call<MechanicListResponse> call = apiService.getMechanicList();

        call.enqueue(new Callback<MechanicListResponse>() {
            @Override
            public void onResponse(Call<MechanicListResponse> call, Response<MechanicListResponse> response) {
                if (response.body().getData() != null) {
                    mechanicDataList = response.body().getData();
                    adapter = new MechanicListAdapter(getActivity(), mechanicDataList);
            ...
            @Override
            public void onFailure(Call<MechanicListResponse> call, Throwable t) {
