...
public class BookingsFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        viewPagerAdapter.addFragment(new AddBookingsFragment(), "Add Booking");
        viewPagerAdapter.addFragment(new ListBookingsFragment(), "List Booking");
        viewPagerAdapter.addFragment(new PendingBookingsFragment(), "Pending ");
