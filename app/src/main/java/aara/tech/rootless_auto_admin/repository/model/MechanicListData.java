...
public class MechanicListData {
    ...
    public String getPhysical_ads() {
        return physical_ads;
    }

    public void setPhysical_ads(String physical_ads) {
        this.physical_ads = physical_ads;
    }
